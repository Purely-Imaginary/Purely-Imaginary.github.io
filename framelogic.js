...
console.log("Przeliczanie napiêcia akumulatora (<10)");
...
else if ($(this).html()==="0") $(this).css({'color': 'black', 'background-color': 'red', 'font-weight': 'bold'} );
else $(this).css({'color': 'black', 'background-color': 'lightgreen'} );
});
console.log("Przeliczanie zasiêgu GSM (<16 / ==0)");
...
console.log("Chowanie 'Praw.odczyt','Wysokoœæ','Kierunek'");
...
console.log("Zmiana nag³ówków Typ,Pamiêæ,GSM,Antena i Alarm");
